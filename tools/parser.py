...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/06/13 11:06:36 by aallali           #+#    #+#              #
#    Updated: 2021/06/13 11:06:38 by aallali          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
def get_input():
	...
	parser.add_argument('-t', action='store', help='Solution replay on terminal, animation speed time value required (Disabled default)', default='0')
	parser.add_argument('--fast', action='store_true', help='fast search', default=False)
