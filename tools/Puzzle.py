...
class Puzzle(object):
    def __init__(self, Node, init_state, goal_state, size, g, u):
        self.init_state = []
        self.goal_state = []
        self.actions = deque()
        self.states = deque()
        ...
        self.start_node = self.Node(self.init_state, None, None, self.start_pos, self.goal_state, self.g, self.u)
    ...
    def solve_A_STAR(self):
        ...
        while pq:
            ...
            for direction in move_directions.keys():
                ...
                if next_state:
                    node = self.Node(next_state, curr_node, move_directions[direction], next_pos, self.goal_state, self.g, self.u)
